...
import com.doudou.workflow.core.constants.DefaultValues;
...
//    protected static final Configuration CONFIG = ConfigurationFactory.getInstance();
    ...
    protected static final boolean SHARE_BOSS_WORKER = false;
    ...
    static {
        TRANSPORT_PROTOCOL_TYPE = TransportProtocolType.valueOf(TransportProtocolType.TCP.name());
//        int workerThreadSize = DefaultValues.DEFAULT_WORKER_THREAD_SIZE;
...
//        }
        TRANSPORT_SERVER_TYPE = TransportServerType.valueOf(TransportServerType.NIO.name());
        ...
        boolean enableHeartbeat =  DefaultValues.DEFAULT_TRANSPORT_HEARTBEAT;
        if (enableHeartbeat) {
