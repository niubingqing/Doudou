...
public class NettyClientConfig extends NettyBaseConfig {
    ...
    private static final boolean ENABLE_CLIENT_BATCH_SEND_REQUEST = DefaultValues.DEFAULT_ENABLE_CLIENT_BATCH_SEND_REQUEST;
...
//
    ...
    public String getRmDispatchThreadPrefix() {
        return RPC_DISPATCH_THREAD_PREFIX + "_" + RpcPoolKey.RpcRole.CLIENT.name();
    }
